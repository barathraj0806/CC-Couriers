            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: large;">
                        ...
                        <a class="nav-item nav-link text-light mr-5" href="tracking.php">Tracking</a>
                        <a class="nav-item nav-link text-light mr-5" href="branches.php">Branches</a>
                        <a class="nav-item nav-link text-light active" href="#">Staff Login</a>
                    </div>
                </div>
            </div>
        </nav>
        <div class="container text-center p-3" style="background-color: rgba(220, 0, 0, 0.5); margin-top: 49px; border-radius: 15px; width: 35%;">        
            ...
            <form class="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="form-group">
                    ...
                    <label style="color: white !important;"><?php echo $errors['id'];?></label>
                </div>
                <div class="form-group">
                    <label style="font-size: 20px;">Password : </label>
                    <input type="password" style="border-radius: 8px;" name="pwd" value="<?php echo htmlspecialchars($pwd)?>" >
                    <label style="color: white !important;"><?php echo $errors['pwd'];?></label>
                </div>
                <label style="color: white !important;"><?php echo $errors['login'];?></label>
                <input type="submit" name="submit" class="btn btn-light text-center" value="Sign In" style="font-size: 20px;">
            </form>
        </div>
        <div class="container-fluid text-center mt-5" style="background-color: rgba(26, 10, 0,0.5); padding: 20px; position: absolute; bottom:0;  ">
