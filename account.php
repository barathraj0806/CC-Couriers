...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg navbar-default navbar-light mb-10" style="background-color: rgb(225, 0, 0); margin-top: 10px; ">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <div class="navbar-nav  " style="margin: 0 auto; font-size: large; ">
                        <a class="nav-item nav-link  mr-5  " href="staff.php" style="color:white;">Back</a>
        ...
        <div class="container text-center" style="width : 50%; background-color: rgba(230, 0, 0, 0.5); margin-top: 10px; border-radius:15px; padding: 5px;">
