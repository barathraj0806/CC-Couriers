<?php
    ...
    $sql = "SELECT * FROM parcel ORDER BY Tracking_ID DESC LIMIT 1";
...
<html>
    ...
    <body style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <div class="container p-5"  style="background-color: rgba(219, 0, 0, 0.3); margin-top: 10px !important">
            ...
            <p><span class="font-weight-bold">Tracking ID : </span><?php echo $order['Tracking_ID']; ?> </p>
        ...
        <div class="container-fluid text-center mt-5" style="background-color: rgba(26, 10, 0,0.5); padding: 12px; position: absolute; bottom: 0; left: 0; ">
